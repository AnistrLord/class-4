...
function preload() {
    ...
    // player2 actions
    player2standingimg = loadImage("assets/ryu/ryu-cfe-win.gif");
...
function setup() {
    ...
    player2button.position(width / 6 * 2.6, height / 4);
    ...
    // invisible ground
    invisibleground = createSprite(width / 2, height - 100, width, 30);
...
function draw() {
    ...
    if (gameState === "level1player1") {
        ...
        enemy1CloseUp = createImg("assets/level1/bision.CloseUppng.png")
...
// function keyPressed(){
// if(keyDown(87) && player.y > height/4 * 2.4){
